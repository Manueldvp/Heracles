      ...
      <div className="max-w-2xl mx-auto">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-zinc-500 text-xs mt-0.5">Acceso bloqueado hasta renovar la suscripcion</p>
          </div>
        </div>
        <SubscriptionStatusCard
          summary={subscriptionSummary}
          title="Tus rutinas no estan disponibles"
          body="Cuando tu entrenador reactive la suscripcion, volveras a ver y activar tus rutinas aqui."
          ctaHref="/client"
